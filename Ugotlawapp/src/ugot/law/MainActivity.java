...
public class MainActivity extends ActionBarActivity implements SearchView.OnQueryTextListener,SearchView.OnCloseListener{	
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        homebtn.setOnClickListener(new ImageButton.OnClickListener(){// ��ü�� Ŭ�� �Ǹ�.
     	   public void onClick(View v){	//onClick �Լ�.
     		 Intent intent = new Intent(MainActivity.this,MainActivity.class);	//MainActivity ��(this) sub�� .
    ...
    mBtn1.setOnClickListener(new ImageButton.OnClickListener(){// ��ü�� Ŭ�� �Ǹ�.
 	   public void onClick(View v){	//onClick �Լ�.
 	
 		 Intent intent = new Intent(MainActivity.this,YearBefore1999.class);	//MainActivity ��(this) sub�� .
			startActivity(intent);
 	   }
    });
